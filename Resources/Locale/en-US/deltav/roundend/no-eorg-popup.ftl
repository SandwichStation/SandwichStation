no-eorg-popup-title = SandwichStation / No EORG / Murderbox
no-eorg-popup-label = Welcome to the End of Round!
no-eorg-popup-message = [bold]End-of-round grief (EORG)[/bold] is [italic]not allowed[/italic] at [bold][color=#00FF00]Sandwich[/color][color=#E8BA71]Station[/color][/bold]. Please stay in character until the lobby screen appears to maintain an immersive environment for everyone. Thank you for respecting the community rules!
